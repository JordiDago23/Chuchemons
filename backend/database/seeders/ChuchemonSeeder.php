...
class ChuchemonSeeder extends Seeder
{
    public function run(): void
    {
        $chuchemons = [
            ...
            ['name' => 'Bambino',      'element' => 'Terra', 'mida' => 'Gran',  'image' => 'bambino.png'],
            ['name' => 'Beeboo',       'element' => 'Aire',   'mida' => 'Petit', 'image' => 'beeboo.png'],
            ['name' => 'Boo-hoot',     'element' => 'Aire',   'mida' => 'Mitjà', 'image' => 'boo-hoot.png'],
            ['name' => 'Cabrales',     'element' => 'Terra', 'mida' => 'Gran',  'image' => 'cabrales.png'],
            ['name' => 'Catua',        'element' => 'Aire',   'mida' => 'Petit', 'image' => 'catua.png'],
            ['name' => 'Catyuska',     'element' => 'Aire',   'mida' => 'Mitjà', 'image' => 'catyuska.png'],
            ['name' => 'Chapapá',      'element' => 'Aigua',   'mida' => 'Gran',  'image' => 'chapapa.png'],
            ['name' => 'Horseluis',    'element' => 'Aigua',   'mida' => 'Petit', 'image' => 'horseluis.png'],
            ['name' => 'Krokolisko',   'element' => 'Aigua',   'mida' => 'Mitjà', 'image' => 'krokolisko.png'],
            ['name' => 'Kurama',       'element' => 'Terra', 'mida' => 'Gran',  'image' => 'kurama.png'],
            ['name' => 'Ladybug',      'element' => 'Aire',   'mida' => 'Petit', 'image' => 'ladybug.png'],
            ['name' => 'Lengualargui', 'element' => 'Terra', 'mida' => 'Mitjà', 'image' => 'lengualargui.png'],
            ['name' => 'Medusation',   'element' => 'Aigua',   'mida' => 'Gran',  'image' => 'medusation.png'],
            ['name' => 'Meekmeek',     'element' => 'Terra', 'mida' => 'Petit', 'image' => 'meekmeek.png'],
            ['name' => 'Megalo',       'element' => 'Aigua',   'mida' => 'Mitjà', 'image' => 'megalo.png'],
            ['name' => 'Mocha',        'element' => 'Aigua',   'mida' => 'Gran',  'image' => 'mocha.png'],
            ['name' => 'Murcimurci',   'element' => 'Aire',   'mida' => 'Petit', 'image' => 'murcimurci.png'],
            ['name' => 'Nemo',         'element' => 'Aigua',   'mida' => 'Mitjà', 'image' => 'nemo.png'],
            ['name' => 'Oinkcelot',    'element' => 'Terra', 'mida' => 'Gran',  'image' => 'oinkcelot.png'],
            ['name' => 'Oreo',         'element' => 'Terra', 'mida' => 'Petit', 'image' => 'oreo.png'],
            ['name' => 'Otto',         'element' => 'Terra', 'mida' => 'Mitjà', 'image' => 'otto.png'],
            ['name' => 'Pinchimott',   'element' => 'Aigua',   'mida' => 'Gran',  'image' => 'pinchimott.png'],
            ['name' => 'Pollis',       'element' => 'Aire',   'mida' => 'Petit', 'image' => 'pollis.png'],
            ['name' => 'Posón',        'element' => 'Aire',   'mida' => 'Mitjà', 'image' => 'poson.png'],
            ['name' => 'Quakko',       'element' => 'Aigua',   'mida' => 'Gran',  'image' => 'quakko.png'],
            ['name' => 'Rajoy',        'element' => 'Aire',   'mida' => 'Petit', 'image' => 'rajoy.png'],
            ['name' => 'Rawlion',      'element' => 'Terra', 'mida' => 'Mitjà', 'image' => 'rawlion.png'],
            ['name' => 'Rexxo',        'element' => 'Terra', 'mida' => 'Gran',  'image' => 'rexxo.png'],
            ['name' => 'Ron',          'element' => 'Terra', 'mida' => 'Petit', 'image' => 'ron.png'],
            ['name' => 'Sesssi',       'element' => 'Terra', 'mida' => 'Mitjà', 'image' => 'sesssi.png'],
            ['name' => 'Shelly',       'element' => 'Aigua',   'mida' => 'Gran',  'image' => 'shelly.png'],
            ['name' => 'Sirucco',      'element' => 'Aire',   'mida' => 'Petit', 'image' => 'sirucco.png'],
            ['name' => 'Peereira',     'element' => 'Aigua',   'mida' => 'Mitjà', 'image' => 'peereira.png'],
            ['name' => 'Trompeta',     'element' => 'Aire',   'mida' => 'Gran',  'image' => 'trompeta.png'],
            ['name' => 'Trompi',       'element' => 'Terra', 'mida' => 'Petit', 'image' => 'trompi.png'],
            ['name' => 'Tux',          'element' => 'Aigua',   'mida' => 'Mitjà', 'image' => 'tux.png'],
            ['name' => 'Chopper',      'element' => 'Aire',   'mida' => 'Gran',  'image' => 'chopper.png'],
            ['name' => 'Cuellilargui', 'element' => 'Terra', 'mida' => 'Petit', 'image' => 'cuellilargui.png'],
            ['name' => 'Deskangoo',    'element' => 'Terra', 'mida' => 'Mitjà', 'image' => 'deskangoo.png'],
            ['name' => 'Doflamingo',   'element' => 'Aire',   'mida' => 'Gran',  'image' => 'doflamingo.png'],
            ['name' => 'Dolly',        'element' => 'Terra', 'mida' => 'Petit', 'image' => 'dolly.png'],
            ['name' => 'Elconchudo',   'element' => 'Aigua',   'mida' => 'Mitjà', 'image' => 'elconchudo.png'],
            ['name' => 'Eldientes',    'element' => 'Terra', 'mida' => 'Gran',  'image' => 'eldientes.png'],
            ['name' => 'Elgominas',    'element' => 'Aigua',   'mida' => 'Petit', 'image' => 'elgominas.png'],
            ['name' => 'Flipper',      'element' => 'Aigua',   'mida' => 'Mitjà', 'image' => 'flipper.png'],
